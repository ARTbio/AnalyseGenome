...
En 2025, les étudiant suivent un workflow minimaliste qui les tient éloignés des lignes de commandes.
Il consiste simplement à déployer dans leur compte GCE une machine virtuelle,
à partir de l'image préalablement préparée et pré-chargée avec toutes les données
primaires nécessaires à leurs analyse dans Galaxy.
